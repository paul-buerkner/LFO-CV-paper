...
existing moments of the importance sampling estimate. 
When $k<0.5$, the importance sampling estimate has finite variance, and
...
prediction task, to which we will refer to as block-$M$-SAP. As the range 
of application of block-$M$-SAP turns out to be rather narrow, we do not 
...
`r fmt(loo_cb$estimates[1, 1], 2)` and thus an even strong overestimation of the
