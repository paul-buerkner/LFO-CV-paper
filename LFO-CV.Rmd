...
In general, for increasing $M$, the approximation will tend to become less
accurate in absolute ELPD units, as the ELPD increment of each observation will
be based on more and more observations. For this example, we see some
...
\@ref(fig:lh-pw-elpd)). However, these differences happend to cancel out in
