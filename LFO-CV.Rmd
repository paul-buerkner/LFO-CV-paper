...
@kitagawa1996; @andrieu2010]. When applying SMC to state space models, we move
...
fails [see @andrieu2010 for an estimation algorithm combining SMC and
MCMC to estimate state space models].
